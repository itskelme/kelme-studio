          ...
          <div className="w-full lg:w-7/12">
            ...
            >
              ...
              <p className="text-secondary text-lg mb-8 max-w-xl leading-relaxed">
                ...
                <span className="text-white block mt-4 font-medium">{community.warning}</span>
              </p>
            ...
            <div className="relative aspect-square border border-white/10 bg-black/40 p-6 flex flex-col justify-end">
              ...
              <div className="space-y-4">
                <div className="bg-white/5 p-3 border-l-2 border-[#5865F2] max-w-[90%]">
                  <p className="text-[10px] text-[#5865F2] font-bold uppercase mb-1">
                    Diego Kelme <span className="text-white/30 text-[8px] ml-2">TECH LEAD</span>
                  </p>
                ...
                <div className="bg-white/5 p-3 border-l-2 border-green-500 max-w-[80%] ml-auto">
                  <p className="text-[10px] text-green-500 font-bold uppercase mb-1">
                    Member <span className="text-white/30 text-[8px] ml-2">PRO</span>
                  </p>
                  <p className="text-xs text-gray-300">
                ...
                <div className="bg-white/5 p-3 border-l-2 border-[#C0392B] max-w-[85%]">
                  <p className="text-[10px] text-[#C0392B] font-bold uppercase mb-1">
                    System <span className="text-white/30 text-[8px] ml-2">BOT</span>
                  </p>
                  <p className="text-xs text-gray-300">
