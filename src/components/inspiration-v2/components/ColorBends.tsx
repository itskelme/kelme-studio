...
export default function ColorBends({
  ...
  useEffect(() => {
    ...
    const handleResize = () => {
      if (!container) return;
      // Fallback to window size if container reports 0 (can happen on initial render in some flex layouts)
  ...
  // Removed default 'relative' class to allow absolute positioning from parent
  return <div ref={containerRef} className={`w-full h-full block ${className}`} style={style} />;
}