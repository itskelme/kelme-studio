    ...
    <section id="roadmap" className="py-32 bg-black relative overflow-hidden" ref={containerRef}>
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="flex flex-col items-center text-center mb-24">
          ...
          >
            {roadmap.title} <span className="text-accent">.</span>
          </motion.h2>
        ...
        <div className="relative max-w-5xl mx-auto">
          ...
          <div className="absolute left-8 md:left-1/2 top-0 bottom-0 w-[2px] bg-white/10 -translate-x-1/2">
             <motion.div 
               className="w-full bg-gradient-to-b from-accent/50 via-accent to-white origin-top relative"
               style={{ height }}
             >
                {/* Glowing Tip */}
                <div className="absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-1/2 w-4 h-4 bg-accent rounded-full shadow-[0_0_20px_5px_hsl(var(--accent))] blur-[2px]" />
             ...
             {roadmap.steps.map((step: any, index: number) => {
               ...
               return (
                 ...
                 >
                    ...
                    {/* Node Point */}
                    <div className="absolute left-8 md:left-1/2 -translate-x-1/2 w-4 h-4 rounded-full bg-black border-2 border-white/20 z-20 top-12 md:top-12 group-hover:border-accent transition-colors duration-500">
                      <motion.div 
          ...
          <div className="relative flex md:justify-center mt-8">
             <div className="w-16 h-16 md:w-20 md:h-20 ml-0 md:ml-0 flex items-center justify-center rounded-full bg-accent text-black relative z-20 shadow-[0_0_50px_-10px_hsl(var(--accent))]">
        ...
        <div className="mt-32 flex flex-col items-center text-center relative z-20">
           ...
           <div className="inline-flex flex-col items-center mb-8 mix-blend-difference">
               ...
               <span className="text-4xl md:text-5xl font-oswald font-bold text-white uppercase tracking-tight">
                 {roadmap.peopleUserCentered.line2} <span className="text-accent">{roadmap.peopleUserCentered.line3}</span>
               </span>
           </div>
